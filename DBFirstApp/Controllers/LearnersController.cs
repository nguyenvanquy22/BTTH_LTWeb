...
namespace DBFirstApp.Controllers
{
    public class LearnersController : Controller
    {
        ...
        public LearnersController(LTWebContext context)
        {
            _context = context;
        }
        ...
        {
            var lTWebContext = _context.Learners.Include(l => l.Major);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LTWebContext.Learners'  is null.");
            }
            var learner = await _context.Learners.FindAsync(id);
            if (learner != null)
            {
